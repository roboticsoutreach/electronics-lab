...
\todo[inline]{Describe how to plug a motor into the V3 kit}

\todo[inline]{Describe the software side of this: read digital input (pin 0),
drive motor forwards if input is low, backwards if input is high.}
